    ...
    <header className="flex items-center justify-between px-10 py-6 bg-white border-b border-surface-dark/10">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex gap-5">
          {/* Email Icon with Dot */}
          <button className="relative text-navy/80 hover:text-navy transition-colors text-2xl">
            ✉️
        ...
        <div className="flex items-center gap-4 pl-8 border-l border-gray-200">
          <div className="relative">
            {/* Background bulat warna orange dari paletmu (#FCA311) */}
            <div className="w-12 h-12 rounded-full bg-primary overflow-hidden flex items-end justify-center border-2 border-white shadow-sm">
              <img 
